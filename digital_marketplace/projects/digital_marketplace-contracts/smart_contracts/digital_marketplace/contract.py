...
class DigitalMarketplace(arc4.ARC4Contract):
    ...
    def opt_in_to_asset(
        ...
        assert not Global.current_application_address.is_opted_in(Asset(self.asset_id)), f"Invalid addr"
        ...
        assert mbr_pay.receiver == Global.current_application_address, f"Invalid rec"
